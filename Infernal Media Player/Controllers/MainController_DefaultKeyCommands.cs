...
namespace Imp.Controllers
{
    public partial class MainController
    {
        public override List<KeyCommand<ImpCommand>> GenerateDefaultKeyCommands()
        {
            ...
            cmds.Add(new KeyCommand<ImpCommand>() { Command = ImpCommand.GlobalPlaypause, Key = Key.Pause, NeedRelease = true, Anywhere = true, ModifierKeys = ModifierKeys.Shift, AllowedStyle = PlayerStyle.MediaPlayer });
