...
namespace WpfAnimatedGif
{
    ...
    public static class ImageBehavior
    {
        ...
        public static void SetIsAnimationLoaded(Image image, bool value)
        {
        ...
        public static BitmapDecoder GetDecoder(BitmapSource image, Image imageControl, out GifFile gifFile)
        {
            gifFile = null;
